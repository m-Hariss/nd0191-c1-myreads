...
This project portrays a mini Library system, that allow used to manage books in multiple distributed shelves.
With the option to choose more books from library. 
## TL;DR
...
└── src
    ...
    ├── css
    │   ├── App.css # Contains styles for App's components.
    │   └── index.css # Contains common styles
    ├── logic
    │   ├── contansts.js # Contains constants i.e. to be used in whole project.
    │   └── utils.css # Contains common utilities i.e. to be used in whole project
